namespace Robots
{
    ...
    public class RobotManager
    {
        ...
        public RobotManager(int capacity)//tested
        {
        ...
        public int Count => this.robots.Count;//tested

        public void Add(Robot robot)//tested
        {
        ...
        public void Remove(string name)//tested
        {
        ...
        public void Work(string robotName, string job, int batteryUsage)//tested
        {
        ...
        public void Charge(string robotName)//2 tests
        {
            Robot robot = this.robots.FirstOrDefault(r => r.Name == robotName);
